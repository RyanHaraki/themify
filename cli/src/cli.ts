...
// Display banner
console.log(chalk.cyan(figlet.textSync('Themify', { horizontalLayout: 'full' })));
console.log(chalk.cyan('A tool to theme your Next.js website using colors from images\n'));

const program = new Command();

program
  .version('1.0.0')
  .description('A CLI tool to theme Next.js websites using colors extracted from images')
  .parse(process.argv);
